...
<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item"><a class="nav-link" href="customer-menu.jsp">Customer Menu</a></li>
    <li class="nav-item"><a class="nav-link" href="employee-menu.jsp">Employee Menu</a></li>
  </ul>
</nav>
